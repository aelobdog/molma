...
expect_bond :: proc(t: ^testing.T, bonds: []Bond, a, b: i32) {
	for bond in bonds {
		if bond.a == a && bond.b == b {
			return
		}
	}
	testing.expect(t, false, fmt.tprintf("expected bond (%d, %d) not found", a, b))
}
